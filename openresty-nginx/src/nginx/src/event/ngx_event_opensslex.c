...
#if (NGX_DEBUG)
    // debug
    output_debug_string(c, "\nngx_ssl_create_connectionex(): rbio_mem(0x%08xd)wbio_mem(0x%08xd), ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd) ... ssl_flags(%d)\n",
...
#if (NGX_DEBUG)
    // debug
    output_debug_string(c, "\nngx_ssl_handshakeex(): rbio_mem(0x%08xd)wbio_mem(0x%08xd), ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd)\n",
        (uintptr_t)c->ssl->rbio_mem, (uintptr_t)c->ssl->wbio_mem,
        (uintptr_t)c->ssl->connection, (uintptr_t)c->ssl->connection->rbio, (uintptr_t)c->ssl->connection->wbio, (uintptr_t)c->ssl->connection->bbio,
...
#if (NGX_DEBUG)
        // debug
        output_debug_string(c, "\nngx_ssl_handshakeex(): handshake ok, rbio_mem(0x%08xd)wbio_mem(0x%08xd), ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd)\n",
            (uintptr_t)c->ssl->rbio_mem, (uintptr_t)c->ssl->wbio_mem,
            (uintptr_t)c->ssl->connection, (uintptr_t)c->ssl->connection->rbio, (uintptr_t)c->ssl->connection->wbio, (uintptr_t)c->ssl->connection->bbio,
            c->id, c->fd, c->destroyed, (uintptr_t)c->read, (uintptr_t)c->write, (uintptr_t)c);
#endif
...
#if (NGX_DEBUG)
                // debug
                output_debug_string(c, "\nngx_ssl_recvex(): SSL_read() parse input data failed, rbio_mem(0x%08xd)wbio_mem(0x%08xd), ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd)\n",
                    (uintptr_t)c->ssl->rbio_mem, (uintptr_t)c->ssl->wbio_mem,
                    (uintptr_t)c->ssl->connection, (uintptr_t)c->ssl->connection->rbio, (uintptr_t)c->ssl->connection->wbio, (uintptr_t)c->ssl->connection->bbio,
                    c->id, c->fd, c->destroyed, (uintptr_t)c->read, (uintptr_t)c->write, (uintptr_t)c);
#endif
...
#if (NGX_DEBUG)
    // debug
    output_debug_string(c, "\nngx_ssl_shutdownex(): rbio_mem(0x%08xd)wbio_mem(0x%08xd), ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd)\n",
        (uintptr_t)c->ssl->rbio_mem, (uintptr_t)c->ssl->wbio_mem,
        (uintptr_t)c->ssl->connection, (uintptr_t)c->ssl->connection->rbio, (uintptr_t)c->ssl->connection->wbio, (uintptr_t)c->ssl->connection->bbio,
        c->id, c->fd, c->destroyed, (uintptr_t)c->read, (uintptr_t)c->write, (uintptr_t)c);
#endif
