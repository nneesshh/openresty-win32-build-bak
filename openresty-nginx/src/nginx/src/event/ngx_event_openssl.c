...
#if (NGX_DEBUG)
    // debug
    output_debug_string(c, "\nngx_ssl_create_connection(): ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd) ... ssl_flags(%d)\n",
...
#if (NGX_DEBUG)
    // debug
    output_debug_string(c, "\nngx_ssl_handshake(): ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd)\n",
...
#if (NGX_DEBUG)
        // debug
        output_debug_string(c, "\nngx_ssl_handshake(): handshake ok, ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd)\n",
            (uintptr_t)c->ssl->connection, (uintptr_t)c->ssl->connection->rbio, (uintptr_t)c->ssl->connection->wbio, (uintptr_t)c->ssl->connection->bbio,
            c->id, c->fd, c->destroyed, (uintptr_t)c->read, (uintptr_t)c->write, (uintptr_t)c);
#endif
        return NGX_OK;
...
#if (NGX_DEBUG)
    // debug
    output_debug_string(c, "\nngx_ssl_shutdownx(): ssl(0x%08xd)rbio(0x%08xd)wbio(0x%08xd)bbio(0x%08xd) on -- c(%d)fd(%d)destroyed(%d)_r(0x%08xd)w(0x%08xd)c(0x%08xd)\n",
        (uintptr_t)c->ssl->connection, (uintptr_t)c->ssl->connection->rbio, (uintptr_t)c->ssl->connection->wbio, (uintptr_t)c->ssl->connection->bbio,
        c->id, c->fd, c->destroyed, (uintptr_t)c->read, (uintptr_t)c->write, (uintptr_t)c);
#endif
