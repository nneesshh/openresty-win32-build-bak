...
"MSWin32-x86-multi-thread-64int-10.0.16299.371" or
	die "Errno architecture (MSWin32-x86-multi-thread-64int-10.0.16299.371) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAENETDOWN WSAECONNREFUSED WSAESTALE WSAENOTEMPTY WSAEPFNOSUPPORT
	WSAEPROTONOSUPPORT WSAENAMETOOLONG WSAEHOSTDOWN WSAENETRESET WSAEBADF
	WSAEOPNOTSUPP WSAECONNRESET WSAESOCKTNOSUPPORT WSAEINPROGRESS WSAEINTR
	WSAEDQUOT WSAEDESTADDRREQ WSAEMSGSIZE WSAEINVAL WSAEFAULT
	WSAECONNABORTED WSAENETUNREACH WSAEAFNOSUPPORT WSAENOMORE
	WSAEHOSTUNREACH WSAEMFILE WSAEADDRNOTAVAIL WSAENOPROTOOPT
	WSAETOOMANYREFS WSAECANCELLED WSAEDISCON WSAEADDRINUSE WSAELOOP
	WSAEUSERS WSAEREMOTE WSAEPROVIDERFAILEDINIT WSAEPROTOTYPE WSAEALREADY
	WSAEISCONN WSAEREFUSED WSAEWOULDBLOCK WSAEPROCLIM WSAENOTCONN
	WSAESHUTDOWN WSAETIMEDOUT WSAEACCES WSAENOTSOCK WSAEINVALIDPROCTABLE
	WSAENOBUFS WSAEINVALIDPROVIDER
    )],
);
